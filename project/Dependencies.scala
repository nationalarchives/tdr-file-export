...
object Dependencies {
  ...
  lazy val awsUtils =  "uk.gov.nationalarchives.aws.utils" %% "tdr-aws-utils" % "0.1.7-SNAPSHOT"
  ...
  lazy val generatedGraphql = "uk.gov.nationalarchives" %% "tdr-generated-graphql" % "0.0.76"
  ...
  lazy val keycloakAdminClient =  "org.keycloak" % "keycloak-admin-client" % "11.0.3"
}
